...
public class DetailPage extends AppCompatActivity {
    ...
    private void getIngredientList(int menuId) {
        ...
        String hp = getApplication().getString(R.string.link) + "api/ingredients.php?menu_id=" + menuId;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (ja_ingredient.length() > 0) {
                                ...
                                JSONArray ja_paid_data_detail = jo_paid_data.optJSONArray("paid");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (networkResponse != null) {
                            ...
                            Toast.makeText(getApplication(), getString(R.string.no_data_found), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void initView() {
        ...
        Glide.with(DetailPage.this).load(R.drawable.img_fond).into(imgGif);
        ...
        String imageUrl = getString(R.string.link) + "images/menu_item_icon/" + subMenuGetSet.getItemImage();
    ...
    public void addToCart(View view) {
       ...
       // cart.setImg_url(  getString(R.string.link) + "images/menu_item_icon/" + subMenuGetSet.getItemImage());
